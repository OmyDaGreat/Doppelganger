= Doppelganger - SVG DSL for Compose Multiplatform
:toc: left
:toclevels: 3
:source-highlighter: highlightjs
:icons: font

A comprehensive and type-safe DSL for creating and rendering SVG graphics in Compose Multiplatform applications.
...
* 🎨 **Type-safe DSL** - Kotlin-first API for building SVG elements
* 🌐 **Multiplatform** - Works on JVM, Android, iOS, JS, and WebAssembly
* 🧩 **Composable** - Integrates seamlessly with Compose UI
* 📐 **Comprehensive** - Supports all major SVG elements and attributes
* 🎭 **Gradients & Effects** - Built-in support for gradients, clipping, and masking
* 🔧 **Path DSL** - Intuitive API for creating complex paths
...
----
dependencies {
    implementation("xyz.malefic:doppelganger:1.0.0")
}
----
